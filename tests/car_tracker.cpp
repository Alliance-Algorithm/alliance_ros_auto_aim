...
public:
  CarTrackerTest() : rclcpp::Node("test") {
...
#pragma region 可视化
    ...
    world_exe::core::EventBus::Subscript<
        ...
        [this](
            const std::shared_ptr<world_exe::interfaces::IArmorInGimbalControl>
                &data) {
          visualization_msgs::msg::MarkerArray msg{};
          world_exe::ros::ArmorMarkerGenerator::generate_all(*data, "odom_imu",
                                                             msg);
