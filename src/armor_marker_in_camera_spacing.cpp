...
public:
    ...
    visualization_msgs::msg::MarkerArray generate(const std::vector<data::ArmorCameraSpacing>& armors_data) {
        if (frame_id_.empty()) {
...
void ArmorMarkerInCameraSpacing::set_frame_id(const std::string& frame_id) { pimpl_->set_frame_id(frame_id); }

std::string ArmorMarkerInCameraSpacing::frame_id() { return pimpl_->frame_id(); }

void ArmorMarkerInCameraSpacing::set_color(float r, float g, float b, float a) { pimpl_->set_color(r, g, b, a); }

void ArmorMarkerInCameraSpacing::set_time_stamp(const rclcpp::Time& time) { pimpl_->set_time_stamp(time); }

visualization_msgs::msg::MarkerArray
    ArmorMarkerInCameraSpacing::generate(const std::vector<data::ArmorCameraSpacing>& armors_data) {
